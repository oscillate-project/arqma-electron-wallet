...
<div class="check-transaction">
    <div class="q-pa-md">
        ...
        <div>
            <OscillateField :label="$t('fieldLabels.transactionId')" :error="$v.txid.$error">
            ...
            <OscillateField class="q-mt-md" :label="$t('fieldLabels.address')" :error="$v.address.$error" optional>
            ...
            <OscillateField class="q-mt-md" :label="$t('fieldLabels.message')" optional>
            ...
            <OscillateField class="q-mt-md" :label="$t('fieldLabels.signature')" :error="$v.signature.$error">
        ...
        <div v-if="status.state.txid">
            ...
            <div class="q-mb-sm" v-if="status.state.received != null">
                ...
                <div><FormatOscillate :amount="status.state.received" raw-value /></div>
            </div>
