...
<q-page class="create-wallet">
    <div class="fields q-mx-md q-mt-md">
        <OscillateField :label="$t('fieldLabels.walletName')" :error="$v.wallet.name.$error">
            <q-input
                v-model="wallet.name"
                @keyup.enter="create"
        ...
        <OscillateField :label="$t('fieldLabels.seedLanguage')">
            <q-select
        ...
        <OscillateField :label="$t('fieldLabels.password')" optional>
            <q-input
