export default {
    ...
    menuItems: {
        ...
        exit: "Wyjdź Oscillate GUI Wallet",
    ...
    notification: {
        ...
        warnings: {
            ...
            usingRemoteNode: "oscillated nie znaleziono, używam zdalnego węzła"
        }
    },
    placeholders: {
    ...
    strings: {
        ...
        oscillateUnlockedBalance: "Odblokowane saldo",
        oscillateUnlockedShort: "Odblokowane",
